...
| US13 | Búsqueda de dueño de mascota | Como médico veterinario, deseo poder buscar citas de clientes agendados por su nombre para poder ubicarlos rápidamente. |
| US19 | Visualización del Historial Médico | Como dueño, deseo visualizar el historial médico de mi mascota para revisar su estado de salud y tratamientos previos. |
...
**Drivers:**
 ...
 - **Integración:** validar registro con Gmail API y respuesta de IA simulada.

 - **Usabilidad:** definir límites claros de contexto para usuarios primerizos.

**Meta de la Iteración:** <br>
Definir y validar el contexto del sistema: implementar los flujos básicos de registro/login, simular el módulo de consultoría por IA, y asegurar que los dueños de las mascotas y veterinarias puedan interactuar correctamente con el sistema de Pawfect Care.
...
<table>
  ...
  <tr>
    <td>Definir AuthService que consuma Gmail API</td>
    <td>Implementar un método de autenticación utilizando un cliente de Gmail API, optimiza la velocidad de registro y acceso a los servicios de la aplicación. </td>
  </tr>
  <tr>
...
<table>
  ...
  <tr>
    <td>Gmail API</td>
    <td>Servicio externo encargado de facilitar el uso automatizado de correos electrónicos para registro y autenticación directa de usuarios.</td>
  </tr>
  <tr>
...
| **Repository**                                                                 | **Branch**     | **Commit Id**  | **Commit Message**                                   | **Date**    |
|--------------------------------------------------------------------------------|----------------|----------------|------------------------------------------------------|-------------|
| `<repo-backend-microservices>`                                                 | `feature/...`  | `abcdef1`      | feat: implementar  microservicio                    | 12/06/25    |
| `<repo-frontend>`                                                              | `feature/...`  | `1234567`      | feat: actualizar integración con microservicio     | 12/06/25    |
|                                                                                                                                                                                          |
...
![deply1](./assets/chapter05/sprint4/azure3.png)

![deply1](./assets/chapter05/sprint4/github1.png)
...
A continuación presentamos nuestro Kanban Board realizado en Trello (o la herramienta que hayan usado) para el Sprint 4. En él se reflejan las distintas columnas (To-Do, In-Progress, To-Review, Done) y la asignación de cada User Story a su estado actual, facilitando la visualización del avance y la identificación de bloqueos:

![Kanban Board 4](./assets/chapter05/sprint2/kanbanboard2.png)

## 5.4  Microservices Implementation

### 5.4.1   Cloud Architecture Diagram
![diagrmacloud](./assets/chapter05/sprint4/cloud-archiquetcture.png)

### 5.4.2 Cloud Architecture Deployment (AWS, Microsoft Azure or Google Cloud)

Hemos elegido Microsoft Azure como nuestra plataforma en la nube debido a su facilidad de integración con servicios gestionados, su escalabilidad automática y su enfoque en la seguridad. Para el despliegue del backend, utilizamos Azure App Services for Containers, lo que nos permitió desplegar nuestros microservicios de forma rápida y sencilla utilizando imágenes Docker previamente configuradas.

Implementamos un flujo de CI/CD automatizado utilizando GitHub Actions, lo cual garantiza que cada vez que se realizan cambios en el código fuente, estos se construyan, testeen y desplieguen automáticamente al entorno en la nube. Esto nos permite mantener un ciclo de desarrollo ágil, reducir errores manuales y asegurar la disponibilidad continua de la aplicación.

Esta arquitectura nos proporciona un entorno moderno, confiable y flexible, capaz de adaptarse al crecimiento del sistema y a nuevas necesidades futuras sin comprometer el rendimiento ni la estabilidad del servicio.

![az1](./assets/chapter05/sprint4/azure1.png)
![az2](./assets/chapter05/sprint4/azure2.png)
![az3](./assets/chapter05/sprint4/azure3.png)
Aca se muestran los pipelines de github actions
![az4](./assets/chapter05/sprint4/github1.png)
...
![abt](/assets/chapter05/sprint4/abt.png)
Link del video about the team:
[https://youtu.be/Pt5OgcHPSow](https://youtu.be/Pt5OgcHPSow)

Para desarrollar de una manera correcta y organizada el trabajo, el equipo siempre designaba deadlines, las cuales eran usualmente 1 o 2 dias antes de la entrega oficial para no estar corriendo con el desarrollo del trabajo. Además, el team leader siempre buscaba la participación de todos los miembros del equipo, y divida el trabajo de manera equitativa para todos trabajar de igual manera. Por otro lado, también nos apoyamos de herramientas como Google meet, Google Docs y Miro.
